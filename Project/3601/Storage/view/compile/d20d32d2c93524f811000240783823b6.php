...
<div id="login">
    <div class="login">
        <div class="login_l">
            <img src="./Public/Home/images/mls17.png" alt="">
        </div>
        <div class="login_r">
            <div class="login_rt">
                <div class="login_rtl">
            ...
            <form onsubmit="return hd_submit(this,'<?php echo U('reg')?>','<?php echo U('login')?>')">
                ...
                <img id="change" style="margin-left:5px;" src="<?php echo U('code')?>&ran=1" alt=""><a style="font-size: 14px;" href="javascript:;" onclick="a()">看不清换一张</a>
                <div class="login_rc2">
