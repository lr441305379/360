...
<form action="" method="post">
    ...
    <div class="form-group">
        ...
        <select name="tid[]" class="form-control" id="">
            ...
            <option value="{{$tt}}"  {{if value="in_array($tt,$group)"}}selected{{endif}}  >{{$vvv}}</option>
            {{endforeach}}
            {{endforeach}}
        </select>
    ...
    <div class="form-group">
        ...
        <input id="exampleInputEmail1"class="form-control"   name="dno" value="{{$oldData['dno']}}">
    </div>
    <input type="hidden" value="{{$oldData['shop_goods_gid']}}" name="shop_goods_gid">
    <input type="hidden" value="{{$_GET['did']}}" name="did">
