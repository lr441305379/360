...
<!--            <option value="" >请选择</option>-->
            ...
            <option value="{{$v['cid']}}" {{if value="$data[0]['shop_cate_cid'] eq $v['cid']"}}selected{{endif}}  >{{$v['cname']}}</option>
            {{endforeach}}
        </select>
    </div>
    <input type="hidden" name="shop_adminuser_id" value="{{$_SESSION['info']['id']}}">

    <div class="form-group">
        <label for="exampleInputEmail1">所属品牌</label>
        <select name="shop_brand_bid" class="form-control">
            {{foreach from="$brandData" value="$v"}}
            <option value="{{$v['bid']}}" {{if value="$data[0]['shop_brand_bid'] eq $v['bid']"}}selected{{endif}} >{{$v['bname']}}</option>
            {{endforeach}}
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder=""  name="gname" value="{{$data[0]['gname']}}">
    </div>

    <div class="form-group">
        <label for="exampleInputEmail1">商品描述</label>
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder=""  name="gdes" value="{{$data[0]['gname']}}">
    </div>

    <div class="form-group">
        <label for="exampleInputEmail1">市场价</label>
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder=""  name="gmprice" value="{{$data[0]['gmprice']}}">
    </div>

    <div class="form-group">
        <label for="exampleInputEmail1">商城价</label>
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder=""  name="gprice" value="{{$data[0]['gprice']}}">
    </div>

    <div class="form-group">
        <label for="exampleInputEmail1">点击次数</label>
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder=""  name="gclick"  value="{{$data[0]['gclick']}}">
    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">库存量</label>
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder=""  name="gstock" value="{{$data[0]['gstock']}}">
    </div>
    ...
    <img src="{{$data[0]['glistimg']}}" alt=""><br/>
    ...
    <div lab="uploadFile">
        ...
        <img src="{{$gdesData['gdimg']}}" alt="">
        <br/><br/><br/><span class="label label-info">商品详细</span>
        <script id="editor" type="text/plain" style="width:100%;height:500px;" name="gdimages">{{$gdesData['gdimages']}}</script>
        <script>
