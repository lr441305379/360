...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder="" required="" name="bsort" value="{{$oldData['bsort']}}">
    </div>
    <div  class="form-group">
        <label for="exampleInputEmail1">是否热门</label>
        <br />
        <label class="checkbox checkbox-inline" for="">
            <input type="radio" name="bis_hot" value="0" {{if value="$oldData['bis_hot'] eq 0"}} checked {{endif}}>不热门
            <input type="radio" name="bis_hot" value="1" {{if value="$oldData['bis_hot'] eq 1"}} checked {{endif}}>热门
        </label>
