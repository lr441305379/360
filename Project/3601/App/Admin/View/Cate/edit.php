...
<form action="" method="post">
    ...
    <div class="form-group">
        ...
        <textarea name="cname" rows="5" cols=""  class="form-control" placeholder="请输入分类按照逗号分开">{{$oldData['cname']}}</textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder="请输入分类排序" required="" name="csort" value="{{$oldData['csort']}}">
    </div>
<!--    <input type="text" name="csort" value="{{$oldData['csort']}}">-->
