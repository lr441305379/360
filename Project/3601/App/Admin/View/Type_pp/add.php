...
<form action="" method="post">
    ...
    <div class="form-group">
        ...
        <input id="exampleInputEmail1" class="form-control" type="text" placeholder=""  name="tpname">
    </div>
    <div id="">
        <label for="">属性类别</label>
        <br />
        <label class="checkbox checkbox-inline" for="">
            <input type="radio" name="tptype" value="0">属性
            <input type="radio" name="tptype" value="1">规格
        </label>

    </div>
    <div class="form-group">
        <label for="exampleInputEmail1">属性值</label>
        <textarea name="tpvalue" rows="5" cols=""  class="form-control" placeholder="请输入属性值按照逗号分开"></textarea>
    </div>
    <input type="hidden" value="$_GET['tid']">
